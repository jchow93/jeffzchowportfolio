...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: "featured-work",
    teamSize: "9 (4 engineers, 2 data scientists, 2 security specialists, 1 PM)",
    budget: "$15B potential annual impact for global merchant ecosystem",
    stakeholders: ["VP Product", "Director of Product", "Head of Security", "Engineering Director", "C-suite"],
    personaContent: {
      investor: {
