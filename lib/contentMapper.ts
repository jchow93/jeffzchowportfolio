...
export const projects: Project[] = [
  ...
  // Featured Work - Professional projects
  {
    ...
    teamSize: "5 (2 engineers, 1 designer, 1 AI/ML engineer, 1 PM)",
    budget: "$100K+ revenue generated in 8-week initiative",
    stakeholders: ["CEO", "CTO", "Sales Director"],
    personaContent: {
      founder: {
  ...
  },
  {
    ...
    category: "featured-work",
    teamSize: "8 (3 engineers, 2 designers, 1 data scientist, 2 PMs)",
  ...
  },
  {
    ...
    description: "Designed a cross-merchant identity verification system with 75% predictive accuracy. Shipped a proactive defense model with a $15B potential annual impact for the global merchant ecosystem.",
    ...
    approach: "Leveraged Visa's unique network to bridge the information gap. I interviewed 10+ merchants to map fraud patterns and discovered that while they saw isolated users, I could see global anomalies (e.g., a single card opening 10 new merchant accounts in 60 seconds). I designed a system that flags high-risk account creation in real-time by analyzing these cross-merchant patterns, shifting the paradigm from reactive detection to proactive prevention.",
  ...
  },
  {
    ...
    category: "featured-work",
    teamSize: "12 (8 engineers, 2 designers, 2 PMs)",
    budget: "$246K annual recovered value from $480 investment",
    stakeholders: ["CEO", "CTO", "Engineering Director"],
    personaContent: {
      founder: {
  ...
  },
  {
    ...
    category: "featured-work",
    teamSize: "6 (3 engineers, 1 designer, 2 PMs)",
    budget: "$130K annual savings",
    stakeholders: ["VP Product", "Engineering Director", "Sales Director"],
  },
  {
    ...
    category: "featured-work",
    teamSize: "7 (3 engineers, 2 designers, 1 blockchain specialist, 1 PM)",
  ...
  },
  {
    ...
    category: "featured-work",
    teamSize: "5 (2 engineers, 1 designer, 1 ML engineer, 1 PM)",
  ...
  },
  {
    ...
    category: "featured-work",
    teamSize: "4 (2 engineers, 1 designer, 1 PM)",
  ...
  },
  {
    ...
    category: "featured-work",
    teamSize: "5 (2 engineers, 1 hardware specialist, 1 designer, 1 PM)",
    budget: "$240K annual savings opportunity identified",
    stakeholders: ["CEO", "Restaurant Owner", "Engineering Lead"],
  },
  {
    id: "productbot-okrs",
    ...
    category: "featured-work",
    teamSize: "3 (1 engineer, 1 designer, 1 PM)",
  ...
  },
  {
    ...
    category: "featured-work",
    teamSize: "4 (2 engineers, 1 ML engineer, 1 PM)",
  ...
  },
  {
    ...
    category: "featured-work",
    teamSize: "6 (2 engineers, 2 designers, 1 game designer, 1 PM)",
  ...
  },
  {
    ...
    category: "featured-work",
    teamSize: "15+ (8 engineers, 4 designers, 2 creative directors, 1 PM)",
